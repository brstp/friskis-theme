...
function post_type_updated_messages( $messages ) {
        ...
        $messages['fs_news'] = array(
                0 => '', // Unused. Messages start at index 1.
                1 => sprintf( __('Nyheten uppdaterad. <a href="%s">Visa nyheten</a>'), esc_url( get_permalink($post_ID) ) ),
                2 => __('Custom field updated.'),
                3 => __('Custom field deleted.'),
                4 => __('Nyheten uppdaterad.'),
                5 => isset($_GET['revision']) ? sprintf( __('Nyheten återtälld till version %s'), wp_post_revision_title( (int) $_GET['revision'], false ) ) : false,
                6 => sprintf( __('Nyheten publicerad. <a href="%s">Visa nyheten</a>'), esc_url( get_permalink($post_ID) ) ),
                7 => __('Nyheten sparad.'),
                8 => sprintf( __('Nyheten skickad. <a target="_blank" href="%s">Förhandsgranska nyheten</a>'), esc_url( add_query_arg( 'preview', 'true', get_permalink($post_ID) ) ) ),
                9 => sprintf( __('Nyheten schemalagd: <strong>%1$s</strong>. <a target="_blank" href="%2$s">Förhandsgranska nyhet</a>'),
                // translators: Publish box date format, see php.net/date
                date_i18n( __( 'M j, Y @ G:i' ), strtotime( $post->post_date ) ), esc_url( get_permalink($post_ID) ) ),
                10 => sprintf( __('Nyhetsutkast uppdaterat. <a target="_blank" href="%s">Förhandsgranska nyhet</a>'), esc_url( add_query_arg( 'preview', 'true', get_permalink($post_ID) ) ) ),
        );
